...
Executable code (Node/Bash/etc.) for tasks that require deterministic reliability or are repeatedly rewritten.
...
5. Validate the skill (run validate_skill.sh)
...
Once development of the skill is complete, it must be validated first to ensure it meets all requirements:
...
If validation fails, fix any validation errors and run the packaging command again.
